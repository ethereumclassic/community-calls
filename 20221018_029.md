...
.
With regards to the WeChat and Telegram channels managed by @南离 777, I think we just need to ensure there is a clean separation between those lists and Hebe. I know that is the case. @南离 777 has made that very clear with repeated explanations about his own and @zhang's history. That @南离 777 does not work for Hebe and so on.
