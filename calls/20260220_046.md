...
- ETC Nexus project has been open-sourced, providing testing infrastructure for Ethereum Classic clients with 99.9% success rate
- ECIP 1121 implementation is planned as a low-effort hard fork for 2026, focusing on enabling new smart contract features
- A formal fork coordination process will be established to ensure all stakeholders (miners, node providers, exchanges) are properly notified
- Community calls will now be held at 0200 UTC, with the next call scheduled for March 6, 2026
- Several PRs in the ECIP and EthereumClassic.org repositories need maintainer attention
## Discussed topics
